...
<head>
    ...
    <style>
        ...
        .searchbtn {
            ...
            font-size: 14px;
            float: left;
            background: url(../images/icon_search.gif) no-repeat 20px 10px #28bc94;
            height: 40px;
            padding-left: 30px;
            line-height: 40px;
            color: #fff;
        ...
        .searchbtn:hover {
            background-color: #1daf87;
        }
        
        .searchbtngj:hover {
            background-color: #fc8d09;
        }
    </style>
    ...
    <span class="next"></span>  -->
              ...
              <div>前沿动态</div>
                        ...
                        <div class="content">
                            <ul class="list_r1">
                                <li>
                                    <a href="#">人口健康平台工程技术中心2015年度工作总结交流...</a>
                                </li>
                                <li>
                                    <a href="#">人口健康平台科技资源标识规范推广培训在京顺利..</a>
                                </li>
                                <li>
                                    <a href="#">人口健康平台工程技术中心与桂林理工大学环境科...</a>
                                </li>
                                <li>
                                    <a href="#">人口健康平台标准修订草案专家咨询会顺利召开</a>
                                </li>
                                <li>
                                    <a href="#">人口健康平台工程技术中心2015年2015年度工作总结交流2015年度工作总结交流度工作总结交流...</a>
                                </li>
                                <li>
                                    <a href="#">人口健康平台科技资源标识规范推广培训在京顺利..</a>
                                </li>
